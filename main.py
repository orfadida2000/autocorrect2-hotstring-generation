...
def main() -> None:
    """Run the placeholder entry point without starting a pipeline."""
    print(
        "No CLI is configured yet. Use hotstring.pipeline.run_typo_generation(), "
        "run_autocorrect2_check(), or run_full_pipeline()."
    )
